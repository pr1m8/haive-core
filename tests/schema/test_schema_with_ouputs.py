...
class TestAugLLMWithStateSchema:
    ...
    def test_input(self):
        ...
        return {
            ...
            "messages": [
                HumanMessage(content="Please analyze the sentiment and key points of this policy discussion.")
            ]
        }

    def test_create_runnable_with_composed_schema(self, aug_llm_config, composed_schema, test_input):
    ...
    def test_create_runnable_with_managed_schema(self, aug_llm_config, managed_schema, test_input):
        ...
        llm_input = {field: getattr(state, field) for field in input_mapping if hasattr(state, field)}
