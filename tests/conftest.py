...
class MockInvokableEngine(InvokableEngine):
    ...
    def create_runnable(self, runnable_config: RunnableConfig | None = None) -> Any:
        conftest_logger.debug(f"[green]MockInvokableEngine[/green] '{self.name}' create_runnable called")
        return self
...
class MockNonInvokableEngine(NonInvokableEngine):
    ...
    def create_runnable(self, runnable_config: RunnableConfig | None = None) -> Any:
        conftest_logger.debug(f"[yellow]MockNonInvokableEngine[/yellow] '{self.name}' create_runnable called")
