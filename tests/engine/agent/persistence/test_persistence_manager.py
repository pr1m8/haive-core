...
from haive.core.engine.agent.persistence.manager import PersistenceManager, CheckpointerType
...
class TestPersistenceManager:
    ...
    def test_create_persistence_manager_with_postgres_defaults(self):
        ...
        try:
            ...
            try:
                ...
                assert False, f"Setup failed with unhandled exception: {e}"
    ...
    def test_thread_registration_and_listing(self):
        ...
        try:
            ...
            assert False, f"Unhandled exception in thread registration test: {e}"
    ...
    def test_clean_test_threads(self):
        ...
        try:
            ...
            # This would indicate a real bug, not just a connection failure
            assert False, f"Unhandled exception in thread cleanup test: {e}"
    ...
    def test_connection_error_handling(self):
        ...
        try:
            ...
            assert False, f"get_checkpointer() should handle connection error: {e}"
        ...
        try:
            ...
            assert False, f"setup() should handle connection error: {e}"
        ...
        try:
            ...
            assert False, f"register_thread() should handle connection error: {e}"
        ...
        try:
            ...
            assert False, f"list_threads() should handle connection error: {e}"
        ...
        try:
            ...
            assert False, f"delete_thread() should handle connection error: {e}"
        ...
        try:
            ...
            if final_threads:
                for thread in final_threads:
                    for thread_id in thread_ids:
                        assert thread["thread_id"] != thread_id, f"Thread {thread_id} was not properly deleted"
    ...
    def test_connection_parameters_with_special_chars(self):
        ...
        for ssl_mode in ["disable", "allow", "prefer", "require", "verify-ca", "verify-full"]:
            manager = PersistenceManager.from_config(
                persistence_type="postgres",
                db_host="localhost",
                db_port=5432,
