...
def analyze_tool_validation_process():
    ...
    for call in ai_message.tool_calls:
        ...
        if route == "langchain_tool":
            print("      Validation: Check args against tool schema")
            print("      If valid: Include in validated_tool_calls")
            print("      If invalid: Mark as invalid, create error ToolMessage")

        elif route == "pydantic_model":
            print("      Validation: Validate args against Pydantic model")
            print("      If valid: Create success ToolMessage with validated data")
            print("      If invalid: Create error ToolMessage with validation errors")

        elif route == "unknown":
            print("      Validation: Tool not found in engine")
            print("      Result: Create error ToolMessage")
