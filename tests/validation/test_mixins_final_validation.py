...
try:
    ...
    print("   ✅ SUCCESS: V1 structured output worked")
...
try:
    ...
    print("   ✅ SUCCESS: Mixed tools + structured output")
...
try:
    ...
    print("   ✅ SUCCESS: Execution-ready config created")
...
try:
    ...
    print("   ✅ SUCCESS: ValidationNodeV2 config created")
