                ...
                if hasattr(msg, "role") and msg.role == "system":
                    ...
                    new_messages.append(
                        SystemMessagePromptTemplate.from_template(
                            self.aug_config.system_message
                        )
                    )
                    has_system = True
                else:
