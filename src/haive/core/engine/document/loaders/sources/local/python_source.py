...
class PythonSource(FileSource):
    """A source that is a Python file."""

    source_type: SourceType = Field(default=SourceType.PYTHON)
    file_type: LocalSourceFileType = Field(default=LocalSourceFileType.PYTHON)
