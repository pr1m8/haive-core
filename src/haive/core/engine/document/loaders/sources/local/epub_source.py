...
class EpubSource(FileSource):
    """A source that is a Epub file."""

    source_type: SourceType = Field(default=SourceType.EPUB)
    file_type: LocalSourceFileType = Field(default=LocalSourceFileType.EPUB)
