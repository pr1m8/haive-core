...
from typing import Any, Dict, List, Optional, Protocol, TypeVar, Union, AsyncIterator, Iterator, runtime_checkable
...
if TYPE_CHECKING:
    ...
    def assert_agent_protocols(agent_class: type[Agent]):
        ...
        assert issubclass(agent_class, AgentProtocol), "Agent must implement AgentProtocol"
        assert issubclass(agent_class, StreamingAgentProtocol), "Agent must implement StreamingAgentProtocol"
        assert issubclass(agent_class, PersistentAgentProtocol), "Agent must implement PersistentAgentProtocol"
        assert issubclass(agent_class, VisualizationAgentProtocol), "Agent must implement VisualizationAgentProtocol"
        assert issubclass(agent_class, ExtensibilityAgentProtocol), "Agent must implement ExtensibilityAgentProtocol"
        assert issubclass(agent_class, FullAgentProtocol), "Agent must implement FullAgentProtocol"