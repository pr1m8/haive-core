...
from typing import Any, Dict, List, Optional, Set, Type, TypeVar, Generic, \
    Union, get_origin, get_args, Callable, Sequence, TYPE_CHECKING, Annotated, Tuple
...
class StateSchema(BaseModel, Generic[T]):
    ...
    def patch(self, update_data: Dict[str, Any], apply_reducers: bool = True) -> 'StateSchema':
        """
    ...
    def combine_with(self, other: Union['StateSchema', Dict[str, Any]]) -> 'StateSchema':
        """
    ...
    def differences_from(self, other: Union['StateSchema', Dict[str, Any]]) -> Dict[str, Tuple[Any, Any]]:
        """
    ...
    def to_command(self, goto: Optional[str] = None, graph: Optional[str] = None) -> Any:
        """
    ...
    def merge_engine_output(self, engine_name: str, output: Dict[str, Any], apply_reducers: bool = True) -> 'StateSchema':
        """
        ...
        if hasattr(self.__class__, "__engine_io_mappings__"):
            if engine_name in self.__class__.__engine_io_mappings__:
                output_fields = self.__class__.__engine_io_mappings__[engine_name].get("outputs", [])
                for field_name in output_fields:
    ...
    def to_runnable_config(self, thread_id: Optional[str] = None, **kwargs) -> RunnableConfig:
        """
    ...
    @classmethod
    def create_input_schema(cls, engine_name: Optional[str] = None, name: Optional[str] = None) -> Type[BaseModel]:
        """
    ...
    @classmethod
    def create_output_schema(cls, engine_name: Optional[str] = None, name: Optional[str] = None) -> Type[BaseModel]:
        """
        ...
        try:
            ...
            if hasattr(cls, "__structured_models__") and cls.__structured_models__:
                ...
                for model_name, model_path in cls.__structured_models__.items():
                    ...
                    if hasattr(cls, "__structured_model_fields__") and model_name in cls.__structured_model_fields__:
    ...
    @classmethod
    def compare_with(cls, other: Type['StateSchema'], title: Optional[str] = None) -> None:
        """
