...
class MultiQueryRetrieverConfig(RetrieverConfig):
    ...
    llm_config: Optional[Any] = Field(default=None, description="Configuration for the LLM")
    query_count: int = Field(default=3, description="Number of query variations to generate")
