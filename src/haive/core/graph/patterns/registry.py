from typing import Any, Dict, Optional, List, Union, TypeVar, Generic, Callable
import logging
import inspect
...
class GraphPatternRegistry(AbstractRegistry[P]):
    ...
    def register_pattern(
        ...
        **pattern_params
        ...
        pattern_obj = self._convert_to_pattern(pattern, name, pattern_type, description, metadata, **pattern_params)
        return self.register(pattern_obj)
        
    def _convert_to_pattern(self, pattern, name=None, pattern_type=None, description=None, metadata=None, **pattern_params):
    ...
    def register_branch(
        ...
        **branch_params
        ...
        branch_obj = self._convert_to_branch(branch, name, condition_type, description, routes, default_route, **branch_params)
        return self.register(branch_obj)
        
    def _convert_to_branch(self, branch, name=None, condition_type=None, description=None, routes=None, default_route=None, **branch_params):
