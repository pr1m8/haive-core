    ...
    def create_structured_output_node(
        ...
        def node_function(state: Dict[str, Any], config: Dict[str, Any] = None):
            ...
            try:
                ...
                logger.exception(f"Error in structured output processor: {e!s}")
                return Command(
    ...
    def _create_invokable_engine_node(
        ...
        def node_function(state: Dict[str, Any], config: RunnableConfig | None = None):
            ...
            try:
                ...
                logger.exception(f"Error invoking engine: {e}")
    ...
    def _create_vectorstore_node(
        ...
        def node_function(state: Dict[str, Any], config: RunnableConfig | None = None):
            ...
            try:
                ...
                logger.exception(f"Error invoking vector store: {e}")
                return cls._create_error_command(state, str(e), command_goto)
    ...
    def _create_retriever_node(
        ...
        def node_function(state: Dict[str, Any], config: RunnableConfig | None = None):
            ...
            try:
                ...
                logger.exception(f"Error invoking retriever: {e}")
                return cls._create_error_command(state, str(e), command_goto)
    ...
    def _create_non_invokable_engine_node(
        ...
        def node_function(state: Dict[str, Any], config: RunnableConfig | None = None):
            ...
            try:
                ...
                logger.exception(f"Error with non-invokable engine: {e}")
                return cls._create_error_command(state, str(e), command_goto)
    ...
    def _create_generic_engine_node(
        ...
        def node_function(state: Dict[str, Any], config: RunnableConfig | None = None):
            ...
            try:
                ...
                logger.exception(f"Error with generic engine: {e}")
                return cls._create_error_command(state, str(e), command_goto)
