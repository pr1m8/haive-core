...
from typing import Any, Dict, List, Optional, Protocol, Type, Union, Callable, cast
import logging
import importlib

from haive.core.registry.base import AbstractRegistry
from haive.core.graph.node.protocols import NodeProcessor, CommandHandler, InputProcessor, OutputProcessor
...
class NodeTypeRegistry(AbstractRegistry[NodeProcessor]):
    ...
    def register_command_handler(self, handler_type: str, handler: CommandHandler) -> None:
        """
    ...
    def register_input_processor(self, processor_type: str, processor: InputProcessor) -> None:
        """
    ...
    def register_output_processor(self, processor_type: str, processor: OutputProcessor) -> None:
        """
    ...
    def register_default_processors(self) -> None:
        ...
        try:
            ...
            from haive.core.graph.node.processors import (
                InvokableNodeProcessor, AsyncInvokableNodeProcessor, 
                CallableNodeProcessor, AsyncNodeProcessor,
                MappingNodeProcessor, GenericNodeProcessor
            )
            
            from haive.core.graph.node.handlers import (
                StandardCommandHandler, DirectInputProcessor,
                MappedInputProcessor, StandardOutputProcessor,
