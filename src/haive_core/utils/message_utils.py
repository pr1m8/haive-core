...
from typing import Callable, Dict, Any, List, Union,Type,Sequence,Optional
...
def normalize_message(message: Union[Dict[str, Any], BaseMessage]) -> BaseMessage:
    """
...
def normalize_messages(messages: Sequence[Union[Dict[str, Any], BaseMessage]]) -> List[BaseMessage]:
    """
...
def has_tool_calls(state: Union[Dict[str, Any], Any]) -> bool:
    """
...
def get_last_message(state: Union[Dict[str, Any], Any]) -> Optional[BaseMessage]:
    """
...
class MessageNormalizingToolNode:
    ...
    def __init__(self, tools: List[Union[BaseTool, Tool, StructuredTool, Callable]]):
        """
    ...
    def __call__(self, state: Union[Dict[str, Any], Any]):
        """
