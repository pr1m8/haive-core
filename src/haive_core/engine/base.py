...
from typing import Dict, Any, Optional, Union, Type, ClassVar, List, Generic, Callable, TypeVar, Tuple, Protocol, runtime_checkable, get_type_hints, get_origin, get_args
...
class Engine(ABC, BaseModel, Generic[TIn, TOut]):
    ...
    @classmethod
    def get(cls, name: str) -> Optional['Engine']:
        """
    ...
    @classmethod
    def find_by_id(cls, id: str) -> Optional['Engine']:
        """
                ...
                if len(args) >= 1:
                    ...
                    if in_type is not TIn:  # Not the generic parameter itself
                        if isinstance(in_type, type) and issubclass(in_type, BaseModel):
                            return in_type
                        elif get_origin(in_type) is Union:
                            # Handle Union types
    ...
    def get_schema_fields(self) -> Dict[str, Tuple[Type, Any]]:
        ...
        if hasattr(self, "_get_schema_fields") and callable(getattr(self, "_get_schema_fields")):
    ...
    def as_node(self, 
                ...
                output_mapping: Optional[Dict[str, str]] = None) -> Callable:
        """
    ...
    def add_to_graph(self, 
                    ...
                    command_goto: Optional[str] = None,
                    input_mapping: Optional[Dict[str, str]] = None,
                    output_mapping: Optional[Dict[str, str]] = None) -> Any:
        """
...
class EngineRegistry:
    ...
    def get(self, engine_type: EngineType, name: str) -> Optional[Engine]:
        """
