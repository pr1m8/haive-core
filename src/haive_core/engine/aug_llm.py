...
from typing import Optional, List, Type, Dict, Any, Union, Callable, get_type_hints, get_args, get_origin, Tuple, Set
from langchain_core.tools import BaseTool, StructuredTool
from langchain_core.runnables import Runnable, RunnableLambda, RunnableConfig, chain
from langchain_core.output_parsers import BaseOutputParser
from langchain_core.prompts import (
    BasePromptTemplate, ChatPromptTemplate, MessagesPlaceholder, FewShotPromptTemplate,
...
class AugLLMConfig(InvokableEngine[Union[str, Dict[str, Any], List[BaseMessage]], Union[BaseMessage, Dict[str, Any]]]):
    ...
    def for_map_reduce(cls,
                     map_template: Union[str, BasePromptTemplate],
                     reduce_template: Union[str, BasePromptTemplate],
                     llm_config: Optional[LLMConfig] = None,
                     **kwargs):
        """
