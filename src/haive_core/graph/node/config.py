...
class NodeConfig(BaseModel):
    ...
    engine: Engine | str | Callable | None = Field(
        default=None,
    ...
    command_goto: str | Literal["END"] | Send | list[Send | str] | None = Field(
        default=None,
    ...
    def resolve_engine(self, registry=None) -> tuple[Any, str | None]:
