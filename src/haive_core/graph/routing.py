...
from haive_core.graph.graph_builder2 import NodeConfig, NodeType
from haive_core.graph.routers.base import Route
...
class Router:
    ...
    def to_node_config(self) -> NodeConfig:
        ...
        """
        from haive_core.graph.graph_builder2 import NodeConfig, RoutingConfig
