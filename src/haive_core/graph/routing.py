...
from haive_core.graph.routers.base import Route, RoutingConfig
...
from haive_core.registry.registy import register_node
from haive_core.graph.state_schema import StateSchema
from haive_core.graph.ToolManager import tool_manager
from haive_core.graph.graph_builder2 import NodeType, NodeConfig
from haive_core.graph.routers.conditions import RouteCondition, ToolCallCondition, ContentCondition, StateValueCondition, FunctionCondition, CompositeCondition
# Set up logging
...
class Router:
    ...
    def to_node_config(self) -> NodeConfig:
        ...
        """
        from haive_core.graph.graph_builder2 import NodeConfig, NodeType, RoutingConfig
