...
from typing import Any, Dict, Optional, Union, Callable, Type, List, Tuple, Literal, get_type_hints
...
class Branch:
    ...
    def __init__(
        ...
        function: Optional[Callable[[Dict[str, Any]], bool]] = None,
    ...
    def evaluate(self, state: Dict[str, Any]) -> str:
        ...
        try:
            ...
            if self.function:
                ...
                if self.comparison in ["exists", "not exists"]:
    ...
    @classmethod
    def from_function(cls, function: Callable[[Dict[str, Any]], Union[bool, str]], 
                    destinations: Optional[Dict[Union[bool, str], str]] = None,
